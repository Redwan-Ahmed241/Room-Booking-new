      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/" className="text-slate-700 hover:text-primary-600 transition-colors font-medium">
              Home
            </Link>
            <Link to="/rooms" className="text-slate-700 hover:text-primary-600 transition-colors font-medium">
              Rooms
            </Link>
            <Link to="/villas" className="text-slate-700 hover:text-primary-600 transition-colors font-medium">
              Villas
            </Link>
            <Link to="/about" className="text-slate-700 hover:text-primary-600 transition-colors font-medium">
              About
            </Link>
          </div>
